class DriversController < ApplicationController
  ...
  private
    ...
    def driver_params
      params.require(:driver).permit(:driver_name, :driver_car, :driver_license, :driver_phone, :driver_reg_number, :driver_category, :driver_organization, :driver_experience, :string, :driver_submission)
    end
end
